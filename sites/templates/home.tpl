      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav nav-main">
            ...
            <li><a href='/news.php' >{DICT.News}</a></li>
            {REST_MENU}
            <li><a href='/faq.php' >{DICT.Faq}</a></li>
            <li><a href='/ticket.php' >{DICT.Support}</a></li>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 tab-content">
                    ...
                    <div class="tab-pane form-login {TAB_ACTIVE_LOGIN}"  role="tabpanel" id="form-login">
                        <div class="form-login-content">
                            <p><a class="link-type-1" href="#form-registration" aria-controls="settings" role="tab" data-toggle="tab" >{DICT.Left_SignUp}</a> &nbsp; or &nbsp; <strong class="strong-type-1"> {DICT.Left_Login}</strong></p>
                            <p>&nbsp;</p>
                    ...
                    <div class="tab-pane form-login {TAB_ACTIVE_REG}" role="tabpanel" id="form-registration">
                        <div class="form-login-content">
                            <p><strong class="strong-type-1">{DICT.Left_SignUp}</strong> &nbsp; or &nbsp; <a class="link-type-1" href="#form-login" aria-controls="settings" role="tab" data-toggle="tab" > {DICT.Left_Login}</a></p>
                            <p>{MAIN_ENROLLER} <a href="" data-toggle="tooltip" data-placement="top" title="{MAIN_ENROLLER_B}t">[?]</a></p>
...
-->
        ...
        <div class="row">
            <div class="owl-carousel owl-main">
                <div class="item"><img src="img/owl_image_1.jpg" alt="img1" /></div>
                <div class="item"><img src="img/owl_image_2.jpg" alt="img1" /></div>
                <div class="item"><img src="img/owl_image_3.jpg" alt="img1" /></div>
            </div>
        </div>        
    </div>  
