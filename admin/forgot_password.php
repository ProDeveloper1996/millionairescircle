...
class ZPage extends XPage
{
    ...
    function ocd_list ()
    {
        ...
        $email = "<input type='text' name='email' value='".$this->GetGP ("email")."' maxlength='120' style='width:160px;'>";
    ...
    function ocd_remind ()
    {
        ...
        $count = $this->db->GetOne ("Select Count(*) From `user_admins` Where email='$email'", 0);
        if ($count > 0)
        {
